...
from . import aliases, fields, hooks, ladder, references, thresholds
...
CLAIM_GUARD = claims.compile_claim(
    _SPEC["claim"], aliases=aliases.LITERAL_ALIASES, pack_name="northstar"
)
...
class NorthstarPack:
    ...
    def personas(self) -> list[dict[str, Any]]:
        ...
        # A new vendor's persona, from a directory the CALLER owns - see
