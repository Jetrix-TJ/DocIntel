...
from northstar.aliases import KNOWN_VENDORS, canonical
...
def test_every_canonical_key_has_a_display_name() -> None:
    ...
    from northstar.aliases import DISPLAY_NAMES, KNOWN_VENDORS

    assert set(DISPLAY_NAMES) == KNOWN_VENDORS


def test_digital_direction_display_names_cover_its_carriers() -> None:
    from digitaldirection.aliases import DISPLAY_NAMES, KNOWN_CARRIERS
...
def test_the_two_unreadable_letterheads_have_display_names() -> None:
    ...
    from digitaldirection.aliases import DISPLAY_NAMES
...
def test_golub_corporation_is_a_recognized_managed_client() -> None:
    ...
    from digitaldirection.aliases import MANAGED_CLIENTS
