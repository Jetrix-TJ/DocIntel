# Author a persona for `01-dtss` — blind
...
One file: **`01-dtss/persona.json`**, in the format of
...
pages, meta, source = load_document("docs/persona-regeneration/01-dtss/document.pdf")
for p in pages:
    print(p.text)
