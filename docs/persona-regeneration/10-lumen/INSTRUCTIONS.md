# Author a persona for `10-lumen` — blind
...
One file: **`10-lumen/persona.json`**, in the format of
...
pages, meta, source = load_document("docs/persona-regeneration/10-lumen/document.pdf")
for p in pages:
    print(p.text)
...
```bash
python3 docs/persona-regeneration/reference/try_persona.py 10-lumen
```
