# Author a persona for `09-windstream` — blind
...
One file: **`09-windstream/persona.json`**, in the format of
...
are in `../reference/vocabulary-digitaldirection.md` and `../reference/pack-digitaldirection.md`.
...
- `../reference/vocabulary-digitaldirection.md` — the legal regions, pattern kinds, adjust
  ops, doc types and field names, generated from the code.
- `../reference/pack-digitaldirection.md` — the pack contract: required fields, rosters,
...
pages, meta, source = load_document("docs/persona-regeneration/09-windstream/document.pdf")
for p in pages:
    print(p.text)
...
```bash
python3 docs/persona-regeneration/reference/try_persona.py 09-windstream
```
