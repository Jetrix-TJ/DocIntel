# Author a persona for `04-federal-recycling` — blind
...
One file: **`04-federal-recycling/persona.json`**, in the format of
...
pages, meta, source = load_document("docs/persona-regeneration/04-federal-recycling/document.pdf")
for p in pages:
    print(p.text)
...
```bash
python3 docs/persona-regeneration/reference/try_persona.py 04-federal-recycling
```
