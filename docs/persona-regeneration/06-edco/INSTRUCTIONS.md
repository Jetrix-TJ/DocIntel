# Author a persona for `06-edco` — blind
...
One file: **`06-edco/persona.json`**, in the format of
...
pages, meta, source = load_document("docs/persona-regeneration/06-edco/document.pdf")
for p in pages:
    print(p.text)
...
```bash
python3 docs/persona-regeneration/reference/try_persona.py 06-edco
```
